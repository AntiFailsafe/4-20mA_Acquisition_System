...
void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(DIN_GPIO_Port, DIN_Pin);
  ...
  LL_GPIO_Init(DIN_GPIO_Port, &GPIO_InitStruct);
  ...
  /**/
  LL_GPIO_SetPinPull(Q1_GPIO_Port, Q1_Pin, LL_GPIO_PULL_NO);

  /**/
  LL_GPIO_SetPinPull(IRQ_GPIO_Port, IRQ_Pin, LL_GPIO_PULL_NO);

  /**/
  LL_GPIO_SetPinMode(Q1_GPIO_Port, Q1_Pin, LL_GPIO_MODE_INPUT);
  ...
  /* EXTI interrupt init*/
  NVIC_SetPriority(EXTI2_TSC_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(),0, 0));
